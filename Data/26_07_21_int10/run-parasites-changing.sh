...
#SBATCH --job-name=c2
#SBATCH -o c2%A_%a.out

## Memory requirement in megabytes. You might need to make this bigger.
#SBATCH --mem-per-cpu=2000M

## Launch an array of jobs. This determines your random seeds
#SBATCH --array=100-106

#SBATCH --nodes=1



cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_para_int2
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_para_int2/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_para_int2/flat-reward-1-env.json .
