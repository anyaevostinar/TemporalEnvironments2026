...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_changing_noPara
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_changing_noPara/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_changing_noPara/flat-reward-1-env.json .
cp /Accounts/caldwelll/TemporalEnvironments2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -ENABLE_TEMP_CHANGING_ENVIRONMENT 1 -TEMP_CHANGING_ENVIRONMENT_ORG_TYPE plastic-both" ##changing env not enabled?
