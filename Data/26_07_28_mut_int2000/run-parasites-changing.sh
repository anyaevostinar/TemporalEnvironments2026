...
#SBATCH --job-name=m2k (• ε •)
#SBATCH -o m2k%A_%a.out
...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_int2000
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_int2000/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_int2000/flat-reward-1-env.json .
