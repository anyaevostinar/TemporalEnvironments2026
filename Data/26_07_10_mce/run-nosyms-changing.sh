...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_10_mce
mkdir mutualists_changing_env
cd mutualists_changing_env

mkdir ${SLURM_ARRAY_TASK_ID}
cd ${SLURM_ARRAY_TASK_ID}

cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_10_mce/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_10_mce/flat-reward-1-env.json .
cp /Accounts/caldwelll/TemporalEnvironments2026/SymbulationEmp/symbulation_sgp .

args=" -START_MOI 1 -ENABLE_TEMP_CHANGING_ENVIRONMENT 1 -TEMP_CHANGING_ENVIRONMENT_ORG_TYPE plastic-both"
