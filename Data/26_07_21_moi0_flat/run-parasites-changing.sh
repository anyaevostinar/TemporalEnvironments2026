...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_21_moi0_flat
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_21_moi0_flat/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_21_moi0_flat/flat-reward-1-env.json .
cp /Accounts/caldwelll/TemporalEnvironments2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -START_MOI 0" ##changing env not enabled?
