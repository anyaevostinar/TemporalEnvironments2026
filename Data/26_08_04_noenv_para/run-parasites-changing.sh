...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_08_04_noenv_para
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_08_04_noenv_para/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_08_04_noenv_para/flat-reward-1-env.json .
cp /Accounts/caldwelll/TemporalEnvironments2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -START_MOI 1 -ENABLE_TEMP_CHANGING_ENVIRONMENT 0" ##changing env not enabled?
