...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_para_noChange
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_para_noChange/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_para_noChange/flat-reward-1-env.json .
cp /Accounts/caldwelll/TemporalEnvironments2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -START_MOI 1" ##changing env not enabled?
