...
#SBATCH --job-name=m2^_^
#SBATCH -o m2%A_%a.out
...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_int2
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_int2/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_int2/flat-reward-1-env.json .
