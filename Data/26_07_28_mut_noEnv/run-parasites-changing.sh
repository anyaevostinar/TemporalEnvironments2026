...
#SBATCH --job-name=mne ʕ•ᴥ•ʔ
#SBATCH -o mne%A_%a.out
...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_noEnv
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_noEnv/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_noEnv/flat-reward-1-env.json .
cp /Accounts/caldwelll/TemporalEnvironments2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -START_MOI 1 -ENABLE_TEMP_CHANGING_ENVIRONMENT 0 -TEMP_CHANGING_ENVIRONMENT_ORG_TYPE plastic-both" ##changing env not enabled?
