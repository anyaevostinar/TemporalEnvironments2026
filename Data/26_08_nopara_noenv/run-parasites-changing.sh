...
#SBATCH --job-name=npne
#SBATCH -o npne%A_%a.out
...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_08_nopara_noenv
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_08_nopara_noenv/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_08_nopara_noenv/flat-reward-1-env.json .
cp /Accounts/caldwelll/TemporalEnvironments2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -START_MOI 0 -ENABLE_TEMP_CHANGING_ENVIRONMENT 0" ##changing env not enabled?
