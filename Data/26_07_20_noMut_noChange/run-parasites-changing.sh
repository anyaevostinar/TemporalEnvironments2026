...
#SBATCH --job-name=nmnc
#SBATCH -o nmnc%A_%a.out
...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_noMut_noChange
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_noMut_noChange/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_20_noMut_noChange/flat-reward-1-env.json .
