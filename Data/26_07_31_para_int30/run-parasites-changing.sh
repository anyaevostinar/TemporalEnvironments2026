...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_31_para_int30
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_31_para_int30/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_31_para_int30/flat-reward-1-env.json .
cp /Accounts/caldwelll/TemporalEnvironments2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -START_MOI 1 -ENABLE_TEMP_CHANGING_ENVIRONMENT 1" ##changing env not enabled?
