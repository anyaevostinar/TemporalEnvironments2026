...
#SBATCH --job-name=m2k XD
#SBATCH -o m1k%A_%a.out
...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_int1000
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_int1000/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_28_mut_int1000/flat-reward-1-env.json .
cp /Accounts/caldwelll/TemporalEnvironments2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -START_MOI 1 -ENABLE_TEMP_CHANGING_ENVIRONMENT 1 -TEMP_CHANGING_ENVIRONMENT_ORG_TYPE plastic-both" ##changing env not enabled?
