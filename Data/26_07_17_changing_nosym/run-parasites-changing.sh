...
cd /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_17_changing_nosym
...
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_17_changing_nosym/SymSettings.cfg .
cp /Accounts/caldwelll/TemporalEnvironments2026/Data/26_07_17_changing_nosym/flat-reward-1-env.json .
cp /Accounts/caldwelll/TemporalEnvironments2026/SymbulationEmp/symbulation_sgp .

## THIS IS AN EXAMPLE, UPDATE TO CORRECT THINGS
args=" -START_MOI 0 -ENABLE_TEMP_CHANGING_ENVIRONMENT 1 -TEMP_CHANGING_ENVIRONMENT_ORG_TYPE plastic-both" ##changing env not enabled?
